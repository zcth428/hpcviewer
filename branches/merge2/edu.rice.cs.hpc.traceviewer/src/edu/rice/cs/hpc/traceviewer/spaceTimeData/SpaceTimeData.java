...
public class SpaceTimeData
{
	...
	/** Contains the Call Stack Trace files that are parsed by CallStackTrace to construct the ProcessTimelines.*/
	 ...
	 *	@param depth 			 The depth-slice in the Call Stacks that will be painted.
	...
	public void paintDepthLine(SpaceTimeSamplePainter spp, int depth, int height)
	{
		...
		switch(ptl.size())
		{
			...
			case 2:
			{
				...
				//the call stack sample based on the sample index
