...
public class ExperimentView {
	...
	public void generateView(Experiment experiment) {
		...
		assert vWin != null : "ExperimentManager.setExperiment: ViewerWindow class not found\n";
		...
		for(int k=0;nbChildren>k;k++)
		{
			...
			try {
				arrScopeViews[k] = BaseScopeView.openView(objPage, child, viewIdx, db);
