...
public class Utilities {
	...
	/***
	 * global variable listener to adjust the height of a row manually,
	 * 	depending of the size of the font
	 */
	...
	/**
	 * start listener to adjust the row height manually
	 * @param treeviewer
	 */
