...
public class FilterRankDialog extends TitleAreaDialog {
	...
	protected Control createContents(Composite parent) {
		...
		// Set the title
		setTitle("Ranks Selection");

		// Set the message
		setMessage("Check ranks to be shown and uncheck ranks to be hidden", IMessageProvider.INFORMATION);
